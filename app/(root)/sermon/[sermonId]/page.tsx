  ...
  return (
    <>
      ...
      <div className="p-4">
        ...
        <p className="text-base font-medium leading-relaxed text-body-color text-xs sm:leading-relaxed">{`Published on ${moment(sermon?.publishDate).format("MMMM Do YYYY")}`}</p>
      </div>
    </div>
    </>
  )
