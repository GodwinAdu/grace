            ...
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                <Image
                  ...
                  alt="logo"
                  className="dark:bg-white/50 ring-1 rounded-lg shadow-xl h-12 w-16 object-contain"
                />
              </Link>
            </div>
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  ...
                  className="absolute right-4 top-1/2 block translate-y-[-50%] rounded-lg px-3 py-[6px] ring-primary2 focus:ring-2 lg:hidden"
                >
                  <span
