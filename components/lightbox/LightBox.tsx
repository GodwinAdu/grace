    ...
    <div className="lightbox relative">
      <div className={`lightbox-content fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 ${isOpen ? 'block' : 'hidden'}`}>
        ...
        <Image
          ...
          className="lightbox-image max-w-md  mx-auto"
        />
        <button className="nav-button prev absolute left-4 top-1/2 transform -translate-y-1/2 bg-gray-800 text-black px-4 py-2 rounded-md z-40 md:ml-4 md:mt-0" onClick={goToPreviousImage}>Previous</button>
